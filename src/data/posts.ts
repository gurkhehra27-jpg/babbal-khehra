...
export type Post = {
  slug: string;           // URL-friendly ID ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â no spaces, use hyphens
  title: string;
  subtitle: string;
  excerpt: string;        // Short preview shown on the listing page (1-2 sentences)
  content: string;        // Full post body ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â supports line breaks (\n\n for paragraphs)
  coverImage: string | null; // Path like "/images/blog/my-photo.jpg" ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â or null
...
That is when marketing begins to work.`,
  ...
  },
  {
    ...
    excerpt:
      "We like to think of ourselves as the dominant species, the apex of intelligence, the ones who figured it out. But the more you actually look at reality, the more obvious it becomes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we haven't even scratched the surface.",
    content: `We like to think of ourselves as the "dominant species," the apex of intelligence, the ones who "figured it out." But the more you actually look at reality, the more obvious it becomes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we haven't even scratched the surface. We are stumbling through existence, high on our own cleverness, while the universe smirks in the background.

Here's a brutal list of real, undeniable facts ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â things we can measure, observe, or scientifically admit ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â that prove we still don't understand much of anything.
...
No scientist can explain why you experience being you instead of being just a pile of meat reacting to stimuli. This is called "the hard problem of consciousness," and it's not fringe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â it's one of the most famous gaps in science.
...
The illusion of control is so strong we forget we don't even know how we move our own hand ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we just "decide" to, and it happens.

3. We Don't Know What 95% of the Universe Is Made Of

Look at the stars, planets, and galaxies ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â that's only 5% of the universe's mass and energy.

The rest? Scientists call it dark matter and dark energy ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â placeholders for "we have no idea what this stuff is, but it's there."
...
Memories aren't stored like files on a computer ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â there's no "memory bank." They're smeared across billions of connections, and the system is so complex that we don't actually know how your "self" even holds together.
...
Science can't fully explain it. Sleep might be the most universal human experience ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â and yet it's still a mystery.
...
In other words, we live by the clock ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but we don't even know what the clock is made of.

7. We Don't Know Why Placebos Work

Give someone a sugar pill, tell them it's medicine, and their body starts healing.

The placebo effect is real and measurable ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â it literally changes biology ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but science can't fully explain why belief alone rewires the body.

If thoughts can healÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ what else are they doing that we haven't noticed?
...
We know animals are aware to some degree, but we have no real framework for what their consciousness "feels" like ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â or if some animals experience reality in ways we can't even imagine.
...
Every single one of these facts is mainstream science. No woo, no speculation ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â just things we already know we don't know.

We can split atoms and edit genes, but we don't understand the basic nature of self, thought, time, or life.

We are a young species ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â and maybe that's exciting. Because if there's this much we don't understand, imagine how much is still waiting.`,
    coverImage: null,
    category: "Philosophy",
  ...
  },
  {
    ...
    excerpt:
      "They're at it again. India. Pakistan. The old game. The same smoke, the same speeches, the same broken promises behind louder explosions. And once again ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â who's in the middle of it? Punjab.",
...
And once again ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â who's in the middle of it?
...
When it's war ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we're warriors.

When it's peace ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we're liabilities.

When we protest ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we're terrorists.

When we bleed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we're statistics.
...
1947 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â You split us in half and called it independence.

1984 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â You burned us alive and called it necessary.

1990s ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â You silenced us and called it stability.

2020 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â We protested starvation and you called us separatists.

And now?

2025 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â You put us in the middle of missiles and drone strikes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â again ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â and call it defense.
...
We want you to stop pretending we're only Indian when you need heroes, and not Indian when we ask for respect.`,
  ...
  },
  {
    ...
    excerpt:
      "Something's off. You can feel it. Like a quiet hum beneath everything. The world is functioning ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â lights on, phones charged, deliveries on time ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but underneath the hum of this well-oiled machine is a silent scream.",
...
South Asia: IndiaÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œPakistan airstrikes escalate. One side claims jets downed. The other calls it fake. Meanwhile, social media floods with war-core aesthetic edits.

Europe: Ukraine is still at war. It's now background noise.

US: School shootings, climate disasters, economic anxiety ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â scroll, like, scroll.
...
Desensitised. Addicted. Awakened ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but only when the world breaks.
...
So when the world shakes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â through war, disaster, or global blackout warnings ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â it jolts people awake.
...
AI-generated apocalypse art is now a vibe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â neon ruins, glitching skies, divine darkness.
...
And maybe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â just maybe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â if it all breaks, something real can rise.

A system built on truth.

On chaos, yes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but at least honest chaos.
...
"Let it all fallÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦"
...
Accept the truth. That you're not crazy. That this world is broken. And that maybe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â just maybe ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â you were born to be one of the few who rebuild when the old world finally collapses.
...
But maybe that's the beginning.`,
  ...
  },
  {
    ...
    excerpt:
      "Words have always held a unique power ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â the ability to inspire, challenge, and transform. For me, writing isn't just about putting pen to paper; it's a way to explore the intricacies of life, question the status quo, and connect with others on a deeper level.",
    content: `Words have always held a unique power ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â the ability to inspire, challenge, and transform. For me, writing isn't just about putting pen to paper; it's a way to explore the intricacies of life, question the status quo, and connect with others on a deeper level.

My journey began with a simple yet profound curiosity: What drives human thought? Growing up, I was fascinated by the vastness of the universe, the beauty of stories, and the complexity of our minds. Over time, this curiosity evolved into a mission ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â to create work that resonates, inspires, and pushes boundaries.
...
This blog is more than a platform ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â it's a space where ideas can flourish. Here, I'll share my reflections on life, insights from my writings, and glimpses into the creative process. Expect everything from philosophical deep dives to practical tips on embracing creativity and purpose.

Join me on this journey of words ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â to explore unspoken truths, challenge conventional ideas, and discover new perspectives. Isn't that what storytelling is all about?
...
The ego ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â that sense of "I", of selfhood, of distinctness from the world ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â is not a wall between you and enlightenment. It is the door. And like any door, you cannot walk through it if you have demolished it first.
...
I wrote Ego & Enlightenment because I got tired of philosophies that asked me to disappear. I wanted a philosophy that asked me to show up ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fully, consciously, and without apology.
...
This is that philosophy.`,
  ...
  },
  {
    ...
    excerpt:
      "Not alive in the biological sense ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â breathing, pulse, metabolism. Alive in the way that matters. Present. Burning. Conscious of the fact that you exist.",
    content: `There is a moment ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â I think most people have had it ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â where you catch yourself going through the motions and wonder: am I actually here?
...
To be alive, in the way that actually matters, is to be in contact with your own experience. Not managing it, not optimising it, not performing it for an audience ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â but actually feeling it.

Most of us spend extraordinary amounts of energy avoiding exactly that.

We build elaborate systems of distraction. We call it productivity. We call it mindfulness. We call it being busy. But underneath all of it is the same terror: if I stop, if I get quiet, if I actually look ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â what will I find?
...
At its core, the idea is simple: you are not a fixed thing waiting to be discovered. You are an ongoing design. Every thought, every habit, every story you tell yourself about who you are ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â these are not facts about you. They are choices, even when they do not feel like choices.
...
This is not positive thinking. This is not manifestation. This is architectural work ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â slow, deliberate, often uncomfortable.

The three pillars of Blueprint Theory are:

1. Awareness ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â seeing the blueprint you are currently living from
2. Interrogation ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â questioning which parts serve you and which parts were handed to you
3. Design ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â consciously building the version of yourself you choose to be
