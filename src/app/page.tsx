 ...
 */}
 ...
 detail: "Showing up where people, policy, and opportunity meet, then building systems around it.",
 },
 {
 label: "Published",
 ...
 {/* Date hidden on mobile to reduce noise in a tight row */}
 <span className="hidden sm:inline text-[#6b6b8a] text-[11px] font-mono">{post.date}</span>
 </div>
 {/* line-clamp-2 instead of truncate so titles read properly on narrow screens */}
 ...
 {/* Excerpt hidden on mobile because it is too much at small size */}
