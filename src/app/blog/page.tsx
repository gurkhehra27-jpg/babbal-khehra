                  ...
                  >
                    ...
                    <div className="relative w-full h-52 bg-[#0e0e1a] overflow-hidden">
                      {post.coverImage ? (
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 star-bg">
                          <div className="w-16 h-16 border border-dashed border-[#00e5ff]/20 flex items-center justify-center">
                          ...
                          <p className="text-[#6b6b8a]/50 text-xs font-mono tracking-widest">
                            Add image in posts.ts
                          </p>
                        </div>
                      )}
                      {/* Gradient overlay */}
                    ...
                    >
                      ...
                      <div className="relative w-full md:w-48 h-36 flex-shrink-0 bg-[#0e0e1a] overflow-hidden">
                        {post.coverImage ? (
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 star-bg">
                            <svg className="w-5 h-5 text-[#00e5ff]/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <span className="text-[#6b6b8a]/30 text-[10px] font-mono">No image</span>
                          </div>
                        )}
